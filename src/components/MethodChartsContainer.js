...
import BarChart from "./MethodBarChart";
import AreaChart from "./MethodAreaChart";
...
import { getDeathCountsByAgeAndMethod } from "../utils/Methods";
import { generatallPDF } from "../utils/PDF_Method";

import axios from "axios";

const MethodChartsContainer = ({ inputData, value, ageGroup, year }) => {
  ...
  const newInputData = [
    ...inputData,
    { Year: year, DeathCount: methodDeathCount },
  ];
  ...
  const generatePDF = async () => {
    ...
    const topSentence = `Method : ${value}\nPredcited Year : ${year}\nAge Group : ${ageGroup.replace(
      "-",
      " - "
  ...
  return (
    <Wrapper>
      ...
      <h5>
        Method : {value} | Age Group : {ageGroup} | Year : {year}
      </h5>
...
export default MethodChartsContainer;
